...
import { ItemBasePriceEditComponent } from './item-base-price-edit/item-base-price-edit.component';
import { ComboBasePriceEditComponent } from './combo-base-price-edit/combo-base-price-edit.component';
...
@NgModule({
  declarations: [
    ...
    ComboListComponent,
    ComboEditComponent,
    ItemBasePriceEditComponent,
    ComboBasePriceEditComponent
  ],
  imports: [
